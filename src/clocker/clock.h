 ...
 * @param apb_pre Делитель для шины APB1 (относительно AHB),
 *                 если частота шины получается более 36МГц (ahb_pre = 1, apb_pre = 1)
 *                 делитель будет установлен в CLOCK_APB_PRE_2
 * @return
 */
clock_status_t clock_set_pre(clock_source_t source,
                             clock_ahb_pre_t ahb_pre,
                             clock_apb_pre_t apb_pre);
